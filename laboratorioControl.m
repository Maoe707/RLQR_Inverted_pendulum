...
set_param('exemplo_bloco_modelo/MODELO','A','MODEL.A')
set_param('exemplo_bloco_modelo/MODELO','B','MODEL.B')
set_param('exemplo_bloco_modelo/MODELO','C','MODEL.C')
set_param('exemplo_bloco_modelo/MODELO','D','MODEL.D')
cd ..
